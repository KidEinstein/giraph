...
//  long partitionId, subgraphId;
   ...
   */
  @Override
  public void compute(Subgraph<LongWritable, LongWritable, LongWritable, NullWritable, ShortestPathSubgraphValue, NullWritable> subgraph, Iterable<SubgraphMessage<LongWritable, BytesWritable>> subgraphMessages) throws IOException {
...
//        log("Initializing source vertex = " + sourceVertexID);
        ...
        for (SubgraphVertex<LongWritable, LongWritable, LongWritable, NullWritable, NullWritable> v : subgraph.getSubgraphVertices().getVertices().values()) {
